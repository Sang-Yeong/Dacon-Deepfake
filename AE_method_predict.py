...
--kernel-type AE_method_5fold_b5_10ep --data-folder AE-classification/ --enet-type tf_efficientnet_b3 --n-epochs 10 --image-size 256
'''
...
def main():
    ...
    for fold in folds:
        ...
        df_test[['image_name', 'target']].to_csv(
            os.path.join(args.sub_dir, f'sub_{args.kernel_type}_{args.eval}_{fold}.csv'),
            index=False)
