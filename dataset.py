...
def get_transforms(image_size, attack_strength):
    '''
    ...
    '''
    transforms_train_zero = albumentations.Compose([
        albumentations.Resize(image_size, image_size),
        albumentations.Normalize()
    ])

    transforms_val_zero = albumentations.Compose([
        albumentations.Resize(image_size, image_size),
        albumentations.Normalize()
    ])

    if(attack_strength == 0):
        return transforms_train_zero,transforms_val_zero
    ...
    transforms_train = albumentations.Compose([
        ...
        albumentations.OneOf([
           # albumentations.MedianBlur(blur_limit=attack_strength,always_apply=True),
            #albumentations.MotionBlur(blur_limit=(attack_strength, attack_strength),always_apply=True),
            albumentations.GaussianBlur(blur_limit=(1, attack_strength),always_apply=True),
